import { ICameraComponent } from '../displaySystem';
...
export class CameraComponent extends Component<ICameraComponentDesc> implements ICameraComponent {
  ...
  static current: CameraComponent | null = null;
  ...
  private compositors: CompositorComponent<any>[] = [];
  ...
  create(descr: ICameraComponentDesc) {
  ...
  // la caméra.
  setup(descr: ICameraComponentDesc) {
